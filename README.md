...
Pan Huang, Chentao Li, Bo Liang, Hong Yan, Yongfei Wang, Zhen Gu, Guoqing Fu, Mingrui Ma, Sukun Tian, Yuchun Sun*, Xin Luo*, Xiuwu Bian*, Yifang Ping*, Jing Qin*
...
Here's an overview of our **Actively Interpretable Pathology Foundation Model with Instance-cluster Multi-global Effects driven-Invariance Semantic Self-supervised Disentanglement (AIPFM)** method:
...
To get started with **AIPFM**, follow the installation instructions below.
